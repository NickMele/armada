...
disagree, a component stylesheet nothing imports — Storybook draws that
component correctly and the app draws it unstyled — a domain registry row that
disagrees with the machine it describes, a tool a Drone is offered and not
allowed to call, a generated file that has drifted from the registry it was
generated from, and anything that names a person or a machine.
