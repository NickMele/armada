...
The check engine was ported out of an existing polyglot monorepo, and this grep is what stops
that repo's specifics coming along for the ride — a hardcoded package directory, a vendor
