...
import { FleetSettings, type FleetSettingsRow } from "@armada/components";
...
export type FleetSettingsSheetProps = {
 ...
 */
export function FleetSettingsSheet({ limits, live, floor, onClose, onSave }: FleetSettingsSheetProps) {
