  ...
  areas: [
    {
      ...
      view: [
        {
          file: "packages/settings/src/selectors.ts",
          hunk: "@@ -14,6 +14,9 @@",
          summary: "The selectors read column order from their own module, not the store.",
          tie_to_next: "The reducer that owned column order has to give it up.",
        },
        {
          file: "packages/settings/src/reducer.ts",
          hunk: "@@ -1,8 +1,5 @@",
          summary: "The reducer drops the selectors it carried.",
          tie_to_next: "The package has to export the new path.",
        },
        {
          file: "packages/settings/src/index.ts",
          hunk: "@@ -0,0 +1,2 @@",
          summary: "The package exports the selectors from their new home.",
        },
      ],
    },
    ...
    recorded: foldedReads({
      ...
      diff: diffRead(
        ...
        [
          ...
          "diff --git a/packages/settings/src/reducer.ts b/packages/settings/src/reducer.ts",
          "--- a/packages/settings/src/reducer.ts",
          "+++ b/packages/settings/src/reducer.ts",
          "@@ -1,8 +1,5 @@",
          " export function settings(state, action) {",
          "-  const order = selectColumnOrder(state)",
          "   switch (action.type) {",
