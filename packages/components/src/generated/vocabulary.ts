...
export const GAMING_PATTERN_MEANING: Readonly<Record<string, { readonly headline: string; readonly explanation: string; readonly presets: readonly string[] } | undefined>> = {
  ...
  "no_findings_on_substantial_diff": { headline: "A review found nothing in a large change", explanation: "The gaming check thinks a change this size is unlikely to hold nothing worth raising, so the review may not have read it. A person has to read the change before trusting the clean review.", presets: ["Most of the change is moved or generated code","Nothing in it needed raising","The review's own reasoning shows it read the change"] },
  "findings_not_tied_to_changed_lines": { headline: "A review's findings may not be about this change", explanation: "The gaming check thinks the findings name nothing this change touched, so they may have been written without reading it. A person has to check the findings against the change.", presets: ["The findings name lines this change touched","The findings are about code this change depends on","The review was asked about more than the change"] },
