...
SP="/private/tmp/claude-501/-Users-nickmele-Development-armada/9e12a4c8-adcf-40d1-b5e9-a454c1aea9f7/scratchpad"
PROMPT="$1"; TAG="$2"
CLAUDE=/Users/nickmele/.local/bin/claude
DRONE_PATH="/Users/nickmele/.cargo/bin:/Users/nickmele/.local/bin:/usr/local/bin:/opt/homebrew/bin:/usr/bin:/bin:/usr/sbin:/sbin"
...
cd "$SP/drone-wt"
/usr/bin/env -i \
  PATH="$DRONE_PATH" HOME="/Users/nickmele" LANG="en_US.UTF-8" TERM="dumb" USER="nickmele" \
  "$CLAUDE" -p "$PROMPT" \
