...
| [021](021-docker-hygiene.md) | Armada cleans up after itself in Docker | BUILT | cross-cutting | 171 volumes and 12.0 GB, none of it Armada's — `doctor` reports the two shares apart, `armada manifest prune` can offer what is not Armada's, and a Job that **finishes** now releases what it holds |
