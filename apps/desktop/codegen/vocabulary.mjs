...
lines.push("// what it is doing, from `job-statuses.toml`; whether a Check outcome advances");
lines.push("// a step, from `check-outcomes.toml`; and the protocol version from");
