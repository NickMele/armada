...
use core_model::{
    ...
    ManifestId, ModelName, NewJob, StepId, StepLevelTrigger, StepSeed, StepVerdict, Timestamp,
...
use crate::briefing::{first_turn, resuming_turn, Opening, Stopped, BASELINE};
...
pub(super) fn turn_at(step: &str) -> String {
    first_turn(
        &a_job(),
        &a_workflow(),
        &StepId::new(step),
