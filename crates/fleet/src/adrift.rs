...
pub enum Adrift {
    ...
    /// client as `ManifestReading`, with the previous values still in force.
    /// This is the file itself unreadable, which is Fleet's own ground failing.
    ManifestUnreadable { path: String, cause: io::Error },
