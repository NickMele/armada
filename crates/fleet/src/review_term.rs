    ...
    pub fn at(step: &ResolvedStep) -> Option<Reviewing> {
        ...
        Some(Reviewing(String::from(
            "WHAT THIS PART DELIVERS\n\nThis part's product is Armada's review of the \
             ...
             - says: confident or not_confident, with at most three reasons.\n\
             - areas: every changed file belongs to one, with what changed there.\n\
             - tests: what the tests in the change prove, every test it removed or \
             loosened and why, and changed code no test reaches.\n\
             - findings: each needs_you, small_fix or for_context, and why it is there. \
             A small fix is one a Drone could make without asking anyone.\n\
