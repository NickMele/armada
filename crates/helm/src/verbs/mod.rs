...
use armada_core::envelope::{
    ...
    McpData, PauseData, ProbeData, Projection, ReapPlanData, ReportData, ResumeData, ScanData,
    ServicesData, SkillsData, SpawnData, StatusData, UpDryRun, VerdictData, VerifyData,
};
