...
pub struct JobConfidence {
    ...
    /// Findings a person dismissed, taken out of the three lists above. Since 13.26, #907.
...
/// it is wrong. Since 13.26, #907. **A blank reason is refused by Fleet**, a 422, because
