...
//! [`charkit_core::workspace`]. This module does the two things the core may
...
use charkit_core::config::declared_workspaces;
use charkit_core::ctx::Run;
use charkit_core::error::CharError;
use charkit_core::id::ProjectId;
use charkit_core::workspace::{choose_root, Candidate, Workspace};
...
mod tests {
    use super::*;
    use charkit_core::ctx::{RunOutput, RunRequest, SpawnError};
