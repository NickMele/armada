...
pub use job::{
    ...
    ResolvedStep, Resumption, ScopeClaim, ScopeRevision, ScopeRevisionOutcome, Spent, Standing,
    ...
    ADVANCING_STATUSES, ARTIFACT_EXISTS, DIFF_NONEMPTY, EDGES, EVERY_MANIFEST_CHECK,
