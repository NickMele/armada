...
Run from the project root. This parses all source files, builds the knowledge graph, and writes it to `.gitnexus/`. The script skips the CLAUDE.md / AGENTS.md block and the skill install that a bare `analyze` would write.
