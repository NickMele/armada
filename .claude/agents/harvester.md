...
You are phase 3's **harvester** for charkit. `docs/ARCHITECTURE.md` §2.7 defines
this role; read it if you have not.
...
2. **Privacy.** charkit is public. Never emit the source repo's **name** or **path**, and
   ...
   behaviour are all fine — `docs/harvest.md` §1 publishes exactly those.
